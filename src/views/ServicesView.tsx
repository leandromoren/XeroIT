...
export default function ServicesVista() {
  const testImg = "https://raw.githubusercontent.com/LambdaSchool/UI-III-Flexbox/master/great-idea/img/services-header.jpg"
  const testImg2 = "https://raw.githubusercontent.com/LambdaSchool/UI-III-Flexbox/master/great-idea/img/services-info.png"
    ...
    <>
      <main className={styles.main}>
        ...
        <section id={styles.services}>
          ...
          <p>Creamos soluciones para el futuro de tu empresa</p>
        </section>
